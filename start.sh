...
if [ -n "${SSH_CONNECTION:-}" ]; then
    ...
    echo "==========================================================================="
    echo ""
    echo "  You're running on a server over SSH."
    echo "  To open the pipeline UI in your laptop's browser:"
    echo ""
    echo "  1. On your laptop, in a new terminal, run:"
    echo ""
    echo "       $SSH_CMD"
    echo ""
    ...
    echo ""
    echo "  2. Open http://localhost:$PORT in your laptop's browser."
    echo ""
